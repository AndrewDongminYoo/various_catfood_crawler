...
with open('./MAMACAT_url.txt', 'r', encoding='utf8', newline="") as input:
    formulas_list = []
    for idx, line in enumerate(input.readlines()):
        ...
        image = driver.find_element(
            By.XPATH, '//*[@id="contents"]/div[2]/div[2]/div[1]/div[1]/div/a/img').get_attr('src')
        diction['id'] = idx
        diction['name'] = title
        diction['image'] = image
