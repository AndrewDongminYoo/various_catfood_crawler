...
brand_list = ['BOREAL', 'Dr.Link', 'Farmina Vet Life Feline', 'Halo pets', 'iti Pet Food', 'Mera Finest',
              'Canada Fresh', 'Companion Pets Classic', 'FirstMate', 'Go! Solutions', 'Little BigPaw', 'Nulo Freestyle',
              'Pronature Canada', 'Specific', 'Stella and Chewys', 'Tender and True', 'TIKI CATS']
for brand in brand_list:
    print(result[brand][0])

bore_scrapper = WebScrapper("BOREAL")
bore_script = """
...
farm_scrapper = WebScrapper('Farmina Vet Life Feline')
farm_scrapper.crawl(
...
halo_scrapper = WebScrapper('Halo pets')
halo_scrapper.crawl(
...
iti_scrapper = WebScrapper('iti Pet Food')
iti_scrapper.crawl(
...
mera_scrapper = WebScrapper('Mera Finest')
mera_script = """
...
canada_scrapper = WebScrapper('Canada Fresh')
canada_script = """
...
cp_scrapper = WebScrapper('Companion Pets Classic')
cp_scrapper.crawl(
...
first_scrapper = WebScrapper('FirstMate')
first_script = """
...
go_scrapper = WebScrapper('Go! Solutions')
go_script = """
...
big_scrapper = WebScrapper('Little BigPaw')
big_script = """
...
nul_scrapper = WebScrapper('Nulo Freestyle')
nul_script = """
...
pro_scrapper = WebScrapper('Pronature Canada')
pro_script = """
...
spec_scrapper = WebScrapper('Specific')
spec_script = """
document.querySelectorAll("div.tab-pane.fade").forEach(e=>e.classList.add('active','in'))
"""
spec_scrapper.crawl(
...
chewy_scrapper = WebScrapper('Stella and Chewys')
...
ten_scrapper = WebScrapper('Tender and True')
ten_script = """
document.querySelectorAll("div.tab-pane.fade").forEach(e=>e.classList.add('active','in'));
"""
ten_scrapper.crawl(
...
tiki_scrapper = WebScrapper('TIKI CATS')
tiki_script = """
...
link_scrapper = WebScrapper("Dr.Link")
